...
const video2 = "https://www.youtube-nocookie.com/embed/EkL4ljHduZE";
const p21 =
...
const video3 = "https://www.youtube-nocookie.com/embed/SNh6ql5QFQw";
const p31 =
...
const ref1 =
  "Mena, V. (2022) De Carmen de Bolívar para el mundo: Aniversario 110 del nacimiento del maestro Lucho Bermúdez. ";
const linkRef1 = "https://www.senalmemoria.co/piezas/lucho-bermudez-natalicio";
const ref2 = "Ojaba, E. (2012) Prende la Vela de la Cumbia! Lucho Bermudez!";
const linkRef2 =
  "http://cumbiapoder.blogspot.com/2012/01/prende-la-vela-de-la-cumbia-lucho.html";
const ref3 =
  "Wade, P. (2012) Música, Raza y Nación: Música tropical en Colombia.";
    ...
    <>
      ...
      <div className="container text-center">
        <h1 className="heading">
          {" "}
          ¿"Enblanquecer" la música tradicional?: La obra de Lucho Bermudez{" "}
        </h1>
      </div>
      ...
      <div className="container">
        ...
        <References
          refs={[
            { apa: ref1, url: linkRef1 },
            { apa: ref2, url: linkRef2 },
            { apa: ref3, url: undefined },
          ]}
        />
      </div>
